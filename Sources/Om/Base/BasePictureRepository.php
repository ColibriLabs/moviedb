 ...
 * @method Picture findOneByFileSize($file_size);
 * @method ResultSetIterator findByFileSize($file_size);
 * @method PictureRepository filterByFileSize($file_size, $cmp = Cmp::EQ);
 * @method PictureRepository orderByFileSize($vector = OrderBy::ASC);
 * @method PictureRepository groupByFileSize();
