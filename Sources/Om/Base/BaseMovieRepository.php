 ...
 * @method Movie findOneBySoundexTitle($soundex_title);
 * @method ResultSetIterator findBySoundexTitle($soundex_title);
 * @method MovieRepository filterBySoundexTitle($soundex_title, $cmp = Cmp::EQ);
 * @method MovieRepository orderBySoundexTitle($vector = OrderBy::ASC);
 * @method MovieRepository groupBySoundexTitle();
 * @method Movie findOneByMetaphoneTitle($metaphone_title);
 * @method ResultSetIterator findByMetaphoneTitle($metaphone_title);
 * @method MovieRepository filterByMetaphoneTitle($metaphone_title, $cmp = Cmp::EQ);
 * @method MovieRepository orderByMetaphoneTitle($vector = OrderBy::ASC);
 * @method MovieRepository groupByMetaphoneTitle();
 ...
 * @method Movie findOneBySoundexOriginalTitle($soundex_original_title);
 * @method ResultSetIterator findBySoundexOriginalTitle($soundex_original_title);
 * @method MovieRepository filterBySoundexOriginalTitle($soundex_original_title, $cmp = Cmp::EQ);
 * @method MovieRepository orderBySoundexOriginalTitle($vector = OrderBy::ASC);
 * @method MovieRepository groupBySoundexOriginalTitle();
 * @method Movie findOneByMetaphoneOriginalTitle($metaphone_original_title);
 * @method ResultSetIterator findByMetaphoneOriginalTitle($metaphone_original_title);
 * @method MovieRepository filterByMetaphoneOriginalTitle($metaphone_original_title, $cmp = Cmp::EQ);
 * @method MovieRepository orderByMetaphoneOriginalTitle($vector = OrderBy::ASC);
 * @method MovieRepository groupByMetaphoneOriginalTitle();
