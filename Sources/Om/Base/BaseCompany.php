...
/**
 * Entity class for representation table 'companies'
 */
class BaseCompany extends Entity
{

  const TABLE = 'companies';

  const ID = 'companies.id';
  const TMDB_ID = 'companies.tmdb_id';
  const NAME = 'companies.name';
  const VERSION = 'companies.version';
  const CREATED = 'companies.created';
  const UPDATED = 'companies.updated';
  const ID_KEY = 'id';
