...
<style>
  .movie-backdrop {
    background-image:
      ...
      url(<?php echo $movie->getBackdrop()->getPicturePath(); ?>),
      linear-gradient(
        135deg,
        rgb(0, 128, 102),
        rgb(0, 70, 130)
      ...
      <div class="row">
        <div class="movie-poster">
          <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5">
            <img class="img-responsive" src="<?php echo $movie->getPoster()->getPicturePath(); ?>">
          </div>
          <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
            <h5 style="color: #fff; font-weight: 400">Animation&nbsp;&bull;&nbsp;Crime&nbsp;&bull;&nbsp;Fantasy</h5>
            <h4 style="color: #fff; font-weight: 400"><?php echo $movie->getPoster()->getPicturePath(); ?></h4>
